...
export default class DocenteClassroom extends Component {
    ...
    goNewProject(classroomId, teacherId) {
        window.location.href = "/menudocente_classroom_nuevo_proyecto";
                ...
                <div className="secContainer">
                    ...
                    <div className="mainContent">
                        ...
                        <div className="pro">
                            ...
                            <h2>Proyectos</h2>
                            <div>
                                {this.state.projects.map(project => { return (<div key={project.id} id={project.id}><a href="/menudocente_classroom_proyecto" >{project.name}</a></div>) })}
                            </div>
