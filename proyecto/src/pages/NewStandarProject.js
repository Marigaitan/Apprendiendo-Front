...
export default class NewStandarProject extends Component {
    constructor(props) {        //constructor de mi clase
        ...
        this.state = {
            ...
            methodologyId: -1, form: { projectName: '', description: '', startDate: '', startTime: '', dueDate: '', dueTime: '' }
        };
    }
    ...
    async newStandarProject() {
        ...
        await axios.post(newProjectUrl,
            {
                    ...
                    <div className='whiteBox'>
                        <Form>
                            ...
                            <FormGroup>
                                ...
                                />
                                <Label for="projectName"><h4>Ingrese la descripción del nuevo proyecto:</h4></Label>
                                <Input
                                    type="textarea"
