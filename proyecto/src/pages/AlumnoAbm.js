...
class AlumnoAbm extends Component {
  ...
  async componentDidMount(){
    ...
    .then(response => {
      ...
      const studentAbm = 
      response.data.map(student =>({NombreUsuario: student.username, password: student.password, rol:student.role, cursos: student.classrooms}))
      this.setState({data: studentAbm})
  })
}
